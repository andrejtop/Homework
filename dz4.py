...
lecturer_1 = Lecturer('Lusya', 'Arestovich')
lecturer_1.courses_attached += ['Python']

lecturer_2 = Lecturer('Vladimir', 'Lenin')
lecturer_2.courses_attached += ['Java']

reviewer_1 = Reviewer('Chert', 'Sgori')
reviewer_1.courses_attached += ['Python']
reviewer_1.courses_attached += ['Java']

reviewer_2 = Reviewer('Mac', 'Donalds')
reviewer_2.courses_attached += ['Python']
reviewer_2.courses_attached += ['Java']


student_1 = Student('Vladimir', 'Presnyakov', 'Man')
student_1.courses_in_progress += ['Python']
student_1.finished_courses += ['Введение в программирование']

student_2 = Student('Megan', 'Fox', 'Girl')
